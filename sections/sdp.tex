\section{SDP Relaxations for CSP}\label{sec:sdpRelax}
\maybeinclude{Raghavendra says that his SDP's are ``stronger" than other SDP's. What makes an SDP ``strong"? Is this something other people discuss?}
